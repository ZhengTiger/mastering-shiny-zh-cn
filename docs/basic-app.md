...
<div class="figure">
<img src="demos/basic-app/server.png" alt="Now that we've provided a server function that connects outputs and inputs, we have a fully functional app" width="75%" />
