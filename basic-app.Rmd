...
```{r run-app, out.width = NULL, echo = FALSE, fig.cap = "Run App 按钮位于源窗格的右上角。"}
...
```{r hello-world, out.width = NULL, echo = FALSE, fig.cap = "当您运行上面的代码时，您将看到一个非常基本的 shiny app"}
...
```{r basic-server, echo = FALSE, out.width = "75%", fig.cap = "现在我们已经提供了连接输出和输入的 server function，我们有了一个功能齐全的 app", message = FALSE}
