...
```{r new-project, echo = FALSE, out.width = NULL, fig.cap = "要在 RStudio 中创建新的 Shiny app，请选择 'Shiny Web Application' 作为项目类型"}
...
```{r run-app, echo = FALSE, out.width = NULL, fig.cap = "Run App 按钮允许您选择如何显示正在运行的 app。"}
